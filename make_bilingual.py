...
for chapter_num in range(1, 2): #28
    ...
    # SPANISH
    chapter = AudioSegment.from_mp3("data/{}/{}-{}.mp3".format(learning_lang_title, learning_lang_chapter, chapter_num))
    ...
    print("{} chapter length in seconds: {}".format(learning_lang, es_duration))

    # FRENCH
    chapter = AudioSegment.from_mp3("data/{}/{}-{}.mp3".format(fluent_lang_title, fluent_lang_chapter, chapter_num))
    ...
    print("{} chapter length in seconds: {}".format(fluent_lang, fr_duration))
    ...
    bilingual_audio.export("{}/chapter-{}.mp3".format(outdir, chapter_num), format="mp3", tags={"album": "The Little Prince Bilingual {}-{}".format(fluent_lang_code, learning_lang_code), "artist": "bv", "title": "principito-ch-{}".format(chapter_num)})
